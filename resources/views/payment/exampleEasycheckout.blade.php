...
<div class="container">
    <div class="py-5 text-center">
        <h2>Epres Payment.{{$pres->patient->user->name}}</p>
    </div>

    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                <span class="text-muted">Your Prescription</span>
                <span class="badge badge-secondary badge-pill">1</span>
            </h4>
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Prescription</h6>
            ...
            <form method="POST" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="customer_name" class="form-control" disabled id="customer_name" placeholder=""
                               value="{{$pres->patient->user->name}}" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_mobile" class="form-control" id="mobile"  placeholder="{{$pres->patient->user->phone}}"
                               value="{{$pres->patient->user->phone}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" disabled name="customer_email" class="form-control" id="email"
                           placeholder="{{$pres->patient->user->email}}" value="{{$pres->patient->user->email}}" required>
                    <div class="invalid-feedback">
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2021 epres.me</p>
