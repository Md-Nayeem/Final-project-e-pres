...
class SslCommerzPaymentController extends Controller
{
    ...
    {
        return view('payment.exampleHosted');
    }
    ...
    public function index(Request $request)
    {
        ...
        # In "orders" table, order unique identity is "transaction_id". "status" field contain 
            #status of the transaction, "amount" is the order amount to be paid and "currency" is for 
            #storing Site Currency which will be checked with paid currency.
    ...
    public function payViaAjax(Request $request)
    {
        ...
        # OPTIONAL PARAMETERS
        $post_data['value_a'] = $requestData['pres_id'];
        $post_data['value_b'] = "ref002";
        $post_data['value_c'] = "ref003";
        $post_data['value_d'] = "ref004";
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'address' => $post_data['cus_add1'],
                'transaction_id' => $post_data['tran_id'],
                'prescription_id' => $post_data['value_a'],
                'currency' => $post_data['currency']
            ]);

        //Here update the prescription table column
        // $pres = Prescription::findOrFail($post_data['pres_id']);

        // DB::table('prescriptions')->where('id',$requestData['pres_id'])->update(['order_id',$update_product['id']]);
        ...
        //test
        // $pres = Prescription::findOrFail($post_data['pres_id'])->update('order_id',$update_product['id']);
